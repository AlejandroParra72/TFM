...
traininit <- a[c(2,3,6:9,13,15, 80:289),] 
...
contMatrix <- makeContrasts(diagnoseCDKN1C-diagnoseControl, levels=design)
contMatrix
...
trainR_id1 <- trainR_id[, !colnames(trainR_id) %in% c("cg00701995_TC21", "cg07680319_TC21", "cg08168768_BC21",
                                                      "cg11019858_BC21", "cg11563064_TC21", "cg14262563_BC21",
                                                      "cg20353881_TC21", "cg23868571_BC21", "cg25497767_BC21",
                                                      "cg26572579_BC21", "cg27024342_BC21", "cg27363482_BC21")]
# 
...
p <- ggplot(svmplot, aes(Affected, CDKN1C)) ## Cambiar el segundo argumento de aes según lo que quieras visualizar
